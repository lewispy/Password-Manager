...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\patri\PycharmProjects\Password Manager JSON'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\patri\PycharmProjects\Password Manager JSON\Scripts\deactivate.nu'
